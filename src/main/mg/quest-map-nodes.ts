...
// 终点等于目标字母的就是入边。既有点位与 EO 编码核对于 2026-08-21，7-4 P 补于 2026-09-09，
// 5-6 P1 G 据 2026-09-25 账本实测补入：
//   1-6 N=[14,17] · 5-6 G=[11] Z=[43] · 7-2 G=[7] M=[15] · 7-3 E=[5,8] P=[18,23,24,25]
//   7-4 O=[15] · 7-4 P=[16,21,22,23] · 7-5 K=[11] Q=[19] T=[24,25]
...
export const QUEST_MAP_NODE_TABLE: readonly QuestMapNodeRow[] = [
  ...
  { map: [5, 6], ref: 'P1', spot: 'G', why: '第一血条（运输）Boss；2026-09-25 账本实测 gauge_num=1 时 api_bosscell_no=11（E→G），api_cell_data 色 5 只有这条边' },
  ...
  { map: [7, 5], ref: 'P1', spot: 'K', why: '第一血条 Boss（艦これ攻略 Wiki 7-5 页第一段作战 Boss=K）；2026-09-21 实测边 11（H→K）为 Boss 战，同期 api_cell_data 色 5 只有这条边' },
