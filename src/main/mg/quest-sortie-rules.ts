...
// EO 编成出击的那 86 条逐条对过游戏自己的日文原文——游戏 questlist 的 api_detail
// 是一手，游戏报文未登记的读任务元数据包的 desc_jp 作次级。
...
// 经维护者拍板收进 ARBITRATED 人工手写四格（见该表 880 条）。泛化正则的禁令不变——
...
> = {
  ...
  911: {
    why:
      '正文「的Boss点各达成1次？胜利」问号前无字母。日文原文（游戏任务原文核对，维护者核 2026-09-06）' +
  ...
  945: {
    ...
    why:
      ...
      '日文原文（游戏任务原文核对，维护者核 2026-09-06）「…反復出撃！鎮守府近海、南西諸島近海、鎮守府近海航路の' +
  ...
  1023: {
    why:
      '正文「各取得一次?胜」问号前无字母。日文原文（游戏任务原文核对，维护者核 2026-09-06）' +
  ...
  995: {
    ...
    why:
      ...
      '日文原文（游戏任务原文核对，维护者核 2026-09-06）「…南西海域ペナン島沖深部の敵戦力を撃滅せよ！」' +
