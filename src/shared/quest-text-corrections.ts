...
//
// 第三类错是漏译舰名（维护者裁决 2026-09-21）：384 的日文原文列出 17 舰，
// 中文 desc 只列 16 舰，在「涟」与「长鲸」之间漏了「迅鲸」。
// 同包 memo2 已含「迅鲸」，这里只补齐 desc 的舰名；证据逐字记在该条 basis。
...
export const QUEST_TEXT_CORRECTIONS: readonly QuestTextCorrection[] = Object.freeze([
  {
    questId: 384,
    field: 'desc',
    label: '【期间限定任务】与提督共度秋祭演习！',
    from: '【期间限定演习】以包含「秋云」「秋月」「绫波」「敷波」「白露」「浦风」「滨风」「长波」「藤波」「朝霜」「白云」「胧」「涟」「长鲸」「大淀」「神通」中至少4艘的舰队，在当天内取得4次以上演习胜利！',
    to: '【期间限定演习】以包含「秋云」「秋月」「绫波」「敷波」「白露」「浦风」「滨风」「长波」「藤波」「朝霜」「白云」「胧」「涟」「迅鲸」「长鲸」「大淀」「神通」中至少4艘的舰队，在当天内取得4次以上演习胜利！',
    basis:
      '日文原文「【期間限定演習】「秋雲」「秋月」「綾波」「敷波」「白露」「浦風」「浜風」「長波」「藤波」「朝霜」「白雲」「朧」「漣」「迅鯨」「長鯨」「大淀」「神通」計4隻以上の艦隊で本日中に4回以上演習勝利せよ！」计 17 舰；上游中文 desc 只列 16 舰，漏译「迅鲸」；同包 memo2 已含「迅鲸」。· 维护者裁决 2026-09-21',
  },
  {
    questId: 385,
    field: 'memo2',
  ...
  },
  {
    ...
    to: '解体2艘舰船',
    basis:
      '**游戏机制实测（维护者核 2026-08-27）**：一次批量解体 2 艘直接达成，不需要解体两轮。' +
...
export const applyQuestTextCorrectionsToPack = <T extends { meta?: { id?: string }; data?: unknown }>(
  ...
  for (const skip of report.skipped) {
    ...
    console.warn(
      `[kuma] 任务正文校正跳过：${skip.questId}.${skip.field}（${
