...
// 票据不足（或日文侧压根没有对应小节）。**不许替维护者拍板**：那些一律照上游显示，
// 差异交给面板反推的实测层自己说话。维护者逐件裁完一条，就往下面加一条，机制不变。
...
export const FIT_BONUS_CORRECTIONS: readonly FitBonusCorrection[] = Object.freeze([
  ...
  },
  {
    ...
    why:
      ...
      '游戏装备预览核对（维护者核 2026-08-22；C型改三H ★+2）：「変更後」预览卡上绿箭头只出现在 ' +
