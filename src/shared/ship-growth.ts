 ...
 *
 * 公式与档位全部拿维护者游戏报文实弹验证过（2026-08-11）：
 ...
 *
 * 2026-08-22 面板反推扩到七项前又复验了一遍（游戏报文 423 舰快照，观测日 2026-08-06）：
 ...
 * 还有整段。成长公式游戏报文实测验证到 Lv139，139→188 区间是社区公式外推。
 */
 ...
 * ≤29:+4 档游戏报文无样本，取社区通说（wikiwiki ケッコンカッコカリ），未实测。
 */
...
// 转写补丁 + 游戏报文一手裁定，印证四档）。这里只负责**怎么用**，不重复抄裁决口径。
//
 ...
 * · `ledger` 游戏报文一手（游戏下发的 Lv99 上限）——最硬，无条件压过两 wiki
 * · `multi`  两 wiki 独立一致
 ...
 *    而游戏报文 186 艘空槽舰 × 三项 490 格里，init 端只错了 1 格（第三〇号海防艦 回避）。
