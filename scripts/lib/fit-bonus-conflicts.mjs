...
// **不许自行二选一**：查不到日文原始出处就老实标 UNRESOLVED，别替维护者拍板。
//
// ---- 裁决 ≠ 改数 ----
//
...
export const KNOWN_FIT_BONUS_CONFLICTS = Object.freeze([
  ...
  },
  {
    ...
    why:
      ...
      ' 吃「他白露型」火力+1——这 4 格本方是对的，EO 那边多给了 回避+2。陽炎型改二那 6 格当初因日文页表格与脚注互相打架未裁，现已由维护者实测定案（见文末）。／陽炎型改二 6 格：日文页**自相矛盾**。' +
      ...
      '。同一页两处打架，分析段按纪律未裁。**2026-08-22 由游戏机制核对（维护者核）终审**：C型改三H ★+2 的游戏装备更换画面核对：「変更後」预览卡，' +
